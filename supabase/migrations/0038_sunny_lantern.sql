/*
  # Add position column for color ordering

  1. Changes
    - Add position column to colors table
    - Add trigger to auto-set position for new colors
    - Add function to update positions when colors are reordered
